...
## data selectionné
classic_data = data_train %>%
  as_tibble() %>%
  filter(!is.na(dead_at_censor_months)) %>%
  select(!c(os_months,dead)) %>%
  select(c(age,sex,histology,dead_at_censor_months,cg01102083,cg10327756,cg05058121,cg22856141,cg19414741,cg07875759,cg08314603,cg06337557,cg06210630,
           cg14251536,cg16002441,cg23644624,cg07326665,cg16141678,cg14968603,cg05295671,cg11706163,IKZF2,
           SEMA3B,OR13C3,MIR5192,REP15,TSPAN3,OR5W2,LINC00939,H2AFY2,RNF212,ELMOD2,ANKRD20A3,TAB2,MINDY3,
           C7orf65,FAM126A,SCD,ZNF705G,MIR548AM,ARC,GSAP,IGFBP5,SOCS2_AS1,SLC34A3,CAPN5))
